/*
function Studente(matricola, nome, cognome, dataDascita){
...
function operazioni(){
	var proceduraCalcoloISEE = function(){
		alert("Inizio procedura calcolo ISEE");
	...
	var b = "Inizio seconda operazione";
	alert (b);
	proceduraCalcoloISEE();
}
